...
def main():
    ...
    opts, args = getopt.getopt(sys.argv[1:], 'm:a:g:f:h',["metamap=","ann_path=","gold_ann_path=","save_failed=","help"])
    for opt, arg, in opts:
        if opt in ("-m","--metamap"):
            metamap_path = arg
