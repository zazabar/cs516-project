...
for inputFile1 in inputTextFilePathList: 
    ...
    numberExtra2 = re.sub(r'\<NUM|\>NUM|NUMPM|NUM\s+PM|NUM\s+AM|NUM\:NUM|NUMAM|NUM\:NUMPM|NUM\smg|NUMmg|NUML|NUM\sL|NUMml|NUMml\.|NUMC\.|NUMC|NUMF\.|NUMF|NUMmg\.|\%NUM|\^NUM|\*NUM|\+NUM|\-NUM|NUM\s+NUM\s+NUM|NUM\s+NUM|\=NUM|\#NUM|\/NUM|\~NUM|\`NUM|\"NUM|\'NUM','NUM',numberExtra1)
    ...
    replaceRemapNumberMap1 = re.sub(remapNumberMap11, '1.)',numberExtra2)
